...
My expertise in probabilistic machine learning is further acknowledged through my membership to the [ELLIS Society](https://ellis.eu/person/andres-masegosa) and my roles as an Area Coordinator at a top ML conference like NeurIPS, ICML and AISTATS and as an Area Editor for journals such as *ACM Transactions on Probabilistic Machine Learning* and *Intelligent Data Analysis*. 
